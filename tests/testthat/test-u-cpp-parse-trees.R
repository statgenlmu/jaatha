...
test_that("Trees are extracted for subgroups", {
  sim_output <- tempfile("sim_output")
  tree_file <- tempfile("tree_file")
...
", file=sim_output);
  ...
  expect_equal(parseTrees(c(sim_output, "", sim_output), tree_file, NA), tree_file)
  trees <- scan(tree_file, "character", quiet=TRUE)
  expect_equal(length(trees), 12)
  expect_equal(trees[1], '[2](2:0.865,(1:0.015,3:0.015):0.850);')
  expect_equal(trees[2], '[3](2:0.865,(1:0.015,3:0.015):0.850);')
  expect_equal(trees[3], '[4](2:1.261,(1:0.015,3:0.015):1.246);')
  expect_equal(trees[4], '[11](2:1.261,(1:0.015,3:0.015):1.246);')
  expect_equal(trees[5], '[2](3:0.613,(1:0.076,2:0.076):0.537);')
  expect_equal(trees[6], '[18](3:0.460,(1:0.076,2:0.076):0.384);')
  expect_equal(trees[7], '[2](2:0.865,(1:0.015,3:0.015):0.850);')
  expect_equal(trees[8], '[3](2:0.865,(1:0.015,3:0.015):0.850);')
  expect_equal(trees[9], '[4](2:1.261,(1:0.015,3:0.015):1.246);')
  expect_equal(trees[10], '[11](2:1.261,(1:0.015,3:0.015):1.246);')
  expect_equal(trees[11], '[2](3:0.613,(1:0.076,2:0.076):0.537);')
  expect_equal(trees[12], '[18](3:0.460,(1:0.076,2:0.076):0.384);')
  unlink(tree_file)
})