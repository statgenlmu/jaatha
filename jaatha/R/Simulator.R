setClass("Simulator"
         ##virtual class = no instances will be created
         )
...
simulateWithinBlock<- function(bObject,jaathaObject){
  print(list(ERROR="just called generic simulateWithinBlock \n"))}
setMethod("simulateWithinBlock", signature(bObject = "Block",
                                           jaathaObject = "Jaatha"),
          function(bObject,jaathaObject){
            #time1<-Sys.time()
            ##values in [0-1]
