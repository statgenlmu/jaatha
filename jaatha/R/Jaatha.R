...
setClass("Jaatha",
	representation=representation(
			dm="DemographicModel", 		nPar = "numeric", 
			logMLmax = "numeric",		nTotalSumstat = "numeric",
			nNonJsfsSumstat = "numeric",	popSampleSizes= "numeric", 
			nLoci = "numeric", 		MLest="numeric", 
			seed="numeric", 		externalTheta= "logical", 
			finiteSites= "logical",		parNames = "character",
			resultFile = "character",	debugMode = "logical",
...
Jaatha.initialize <- function(demographicModel, sumStats, seed=numeric(), 
	...
	return(new("Jaatha",demographicModel=demographicModel,
		   	    sumStats=sumStats,
			    seed=seed,
...
setMethod("show","Jaatha",
		function(object){
			...
			#cat(" parRange = ");
			#if(object@nPar>1){
			#	sapply(1:(object@nPar-1),
			#			function(d) cat(object@parRange[[d]], " / "))
			#	cat(object@parRange[[object@nPar]],"\n")
			#}else{ cat(object@parRange[[object@nPar]],"\n")}
			#cat(" nBlocksPerPar =",object@nBlocksPerPar,"\n")        
			#cat(" nSampIni =",object@nSampIni,"\n")   
			#cat(" nSampMain =",object@nSampMain,"\n")      
			...
			#cat(" nNonJsfsSumstat =",object@nNonJsfsSumstat,"\n")               
			#cat(" ssFunc provided =",
