...
parseOutput <- function(file_name, sample_size, loci_number, program = 0L, generate_jsfs = TRUE, generate_seg_sites = FALSE, generate_fpc = FALSE, fpc_breaks_near = numeric(0), fpc_breaks_far = numeric(0), trio_opts = numeric(0)) {
    .Call('jaatha_parseOutput', PACKAGE = 'jaatha', file_name, sample_size, loci_number, program, generate_jsfs, generate_seg_sites, generate_fpc, fpc_breaks_near, fpc_breaks_far, trio_opts)
}
